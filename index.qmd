...
:muscle: Practicar la salida de algunas situaciones horribles

:::

## Como vamos a trabajar {.center}

En su entorno de Git habitual. 
...
Mostrar donde esta Git, la console de R, la terminal.
...
En carpetas temporarias creadas por saperlipopette o no.
...
* Usar `gert::git_config_global_set(name = "core.editor", value = <QUÉ-PREFIERES>)` o la terminal. Por ejemplo en vez de "code" poner "rstudio".
...
- Crea ejercicios en carpetas.

- Muestra donde es el nuevo ejercicio, por si no se abre de forma automatica.

- saperlipopette == R. Tu trabajo de Git == como quieres.
